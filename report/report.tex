...
\section{Background of 3D City Representation}
...
\section{Specific preprocessing for SLU and OSM geodata}
...
\chapter{Implemenation: Evaluation of the quality of geodata}
...
\section{The accuracy classes that will not be focused on}
...
\section{Assesment of dataset completeness}
...
\section{Correspondence by building area}
...
\section{Shape accuracy definition}
...
\section{Closest point and point proximity}
...
\chapter{Implementation: Collision study}
...
\section{Positional accuracy statistics}
...
\section{Completeness by building area}
...
\section{Building matching statistics}
...
\section{Shape accuracy statistics}
...
\chapter{Analysis and Future Work}
...
% TODO: Reduce long section headlines
% TODO: Rename analysis -> conclusions
...
\section{Suggested algorithms for correcting feature overlap}
