...
\begin{abstract}
Modeling a city in 3D has long been a topic of interest in field of computer graphics.
...
This project assesses the feasibility of reconstructing a city from OpenStreetMap (OSM) road and building data, and will focus on the feasibility of including of pedestrian footpaths, by focusing on OSM road and building data in the Stockholm metropolitan area.
...
Description of the field of city reproduction (Parish Müller).
...
Description of procedural modelling of cities (find reference).
...
% TODO: Introduction disposition (See meeting log for suggestions)
