...
% TODO: Try the solution where we only make corrections if the distance to the original points are smaller than max_translation_dist = 2.05
% TODO: Plot features before/after collision. Any conclusions for the analysis?
