...
% TODO: Table of positional offset statistics
% TODO: Table of completeness statistics
% TODO: Statement on completeness

% TODO: Bar plot positional accuracy
% TODO: Bar plot turning functions
...
\begin{table}[]
\begin{tabular}{lllll}
    & Total number of buildings & Area cover & Number of buildings (\%) & Area cover (\%) \\
    OSM & 102755 & 33105023.32... $m^2$ & 60.17\% & 98.18\% \\
    SLU & 170783 & 33718628.97... $m^2$ & 100.00\% & 100.00\%
\end{tabular}
\end{table}

The area cover of the OSM dataset in relation to the SLU dataset was estimated to 98.18\%.

\subsection{Positional offset statistics}
