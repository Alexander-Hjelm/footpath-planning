...
% MONDAY
% TODO: Collision correction: Fix collisions by relaxing both feature_1 and feature_2
% TODO: Collision correction: Store collided features in a tentative map. When a collision is fixed, add both feature_1 and feature_2 to the tentative map
% TODO: Collision correction: Toss features that cannot be corrected, bump a counter per highway type
% TODO: Print/save collision statistics
% TODO: Collision correction run

% TODO: Table for collision correction data in report
% TODO: Quote Todor's paper for geodata import services and current state of the field

% TUESDAY
% TODO: ANALYSIS SECTION, figure out what to write
% TODO: RELATED WORK, mention current sources (Haklay, Fan)
...
% TODO: Collision correction: Edit edge distance function to factor in width of the other path

% WEDNESDAY
% TODO: Proof read entire report
