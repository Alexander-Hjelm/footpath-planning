...
The question is: how can a program identify critical areas where the footpath width is so large that it collides with existing roads?
Can these collisions be easily fixed by making adjustments that are within the positional accuracy of the OSM data?
The features will be categorized according to type, so that the rate of collisions between footpaths and other features can be compared to that of other way types (primary, secondary, residential).
\\
