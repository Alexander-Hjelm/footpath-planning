...
% THURSDAY
% TODO: Fix collision correction script (move statistics collection to a new function, use it in both cases. Ensure that the translation distance is shortest_dist - f1.min - f2.min)
