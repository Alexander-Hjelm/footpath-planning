...
This section will dive into the state-of-the-art use of city reconstruction methods within the research field of urban design.
This chapter will present the motivations for the digitization of urban planning, as well as the most common programs and tools in this area, which are after all not very commonly used in the practise of urban design due to the failure in being able to reflect the unique workspace of urban designers.
The final section will present a brief history of the field of OpenStreetMap data qualification, and present the research papers whose methods are at the foundation of this project.
...
\section{Previous work in qualifying OpenStreetMap data}
...
This chapter will present the evaluation metrics that this project served to obtain, and how they relate to the eventual collision analysis.
...
See section 4 for a detailed technical implementation overview that presents how the relevant metrics were obtained during the statistics collection process.
For the resulting metrics that were obtained, see section 5.
...
Section 4.2 will present at the data collection process for the collision study. It will present how standard road withs were obtained, as well as the algorithm for detemining feature collision that was used.
Section 4.3 will discuss briefly the data sources used in this project, why they were chosen and specific issues with the data collection process.
...
The driving force behind the availablity of VGI is, according to \textbf{(Fan et al, 2014)}, the availablity of high resolution satellite imagery to private individuals. They claim that particularily the imagery from Bing Maps, which launched in 2010, led to an increase in building information in OSM, and the positional error is largely due to the limited resolution in such satellite imagery.
...
% TODO: Move some of the text from method and evaluation to background
% TODO: Read over the sample report to see what they have in the background section
% TODO: Move the rest of the "method and evaluation" text  into the implementation and evaluations section, perhaps creating a new subsection in the implementation section called "Method"
...
\textbf{(Biljecki et al, 2016)} provide an extensive overview of the concept of LOD in GIS mapping.
...
Procedural techniques are, as mentioned, methods for reconstructing or creating 3D automatically, with minimal manual work required. Adding such techniques for content creation into the workflow of city reconstruction will increase the level of detail that is possible, while sacrificing accuracy to the real-world.
