...
\begin{enumerate}
    \item The primary subquestion is: \textbf{How many roads of each type will collide with some other map feature, once they have been given a geometrical width?}. This question aims to find the rate of collision between road features in OSM.
...
In this chapter we will look in details at the evaluation metrics that this project served to obtain, and how they relate to the eventual collision analysis.
For the geodata precision study specifically, we will look in detail at how geodata is qualifyied in general, by examining van Oorts quality criteria.
We will also present how van Oorts critera will be used in the context of this project.
...
The first section will present the motivations for the digitization of urban planning, as well as the most common programs and tools in this area, which are after all not very commonly used in the practise of urban design due to the failure in being able to reflect the unique workspace of urban designers.
The Related work section will present a brief history of the field of OpenStreetMap data qualification, and present the research papers whose methods are at the foundation of this project.
...
In section 4.1 we will look at the data collection process for the geodata precision study. We will look at how to qualify dataset completeness and building correspondence (how many of the buildings in one dataset that can be found in the other) by collecting the cumulative building areas and looking at what buildings have overlapping areas between the two datasets.
We will also look at the difinitions and algorithms neccessary for calculating posiitonal accuracy and a measure for shape accuracy.
In section 4.2 we will look at the data collection process for the collision study. We will look at the how standard road withs were obtained, as well as the algorithm for detemining feature collision that was used.
In section 4.3 we will discuss briefly the data sources used in this project, why they were chosen and specific issues with the data collection process.
...
Here we present the results of the statistics collections that were made as part of this project.
...
We will present our estimate of the positional accuracy of the OSM dataset, as well as the dataset completeness and statistics about building correspondence and shape accuracy.
...
\subsection{Building correspondence statistics}
...
Now that the colliison metrics have been obtained, we are in a good position to draw conclusions about the technical feasibility of 3D city reproduction from OSM data.
We will begin by looking at the geodata precision study, and use the outcome of that study to assess the quality of the positional accuracy estimate, by looking at the dataset completeness, the low semantic accuracy and the unique characteristics of the Stockholm area.
Secondly we will look at the collision study.
We will make the claim that footpaths will not be more problematic than other road types in city reproduction from OSM data, and motivate this with the data obtained in section 6.1.
We will look at the character of the feature collision cases and identify the most common cases, as well as present geometrical algorithms for how to correct each case automatically.
...
% Onsdag:
% TODO: Split up introduction, more subsections
% TODO: Delimitations in Introduction, after RQ
% TODO: Go over all images, add a line about their origins
% TODO: Merge: Results and metrics + Analysis -> Evaluation, with result/analysis subsections
% TODO: Rename: Implementation overview -> Methodology
% TODO: Background should be the second chapter

% Torsdag:
% TODO: Add source of image on page 1
% TODO: Mention that positional accuracy will be the focus early on
% TODO: Move: 2.1.1: Accuracy criteria that will not be focused on -> Delimitations
% TODO: Formal tone, never use us, we, me
% TODO: Move content from chapters 1, 3 and 4 to Background
% TODO: Switch to numerical citations
...
We have however yet to touch upon the possibilities of road network modelling in the broader context of 3D city reproduction, and what are the remaining challenges for accurate 3D city reproduction?
What techniques can we use to complement our basic system of importing street and building data and create a rich and living virtual city?
In this section we will place everything we have learnt so far in the broader context of GIS and city modeling, focusing on the research fields of 3D media and city planning.
