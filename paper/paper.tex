...
\begin{figure}[H]
\centering
\includegraphics[height=0.5\textheight]{img_match_1_1}
\caption{An example of a 1:1 building match, where the sought-after building was found both in the OSM (red) and SLU (blue) datasets.}
\label{fig:space}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[height=0.5\textheight]{img_match_1_n}
\caption{An example of a 1:n building match, where the sought-after building was represented as one polygon in the OSM (red) dataset, but divided into many smaller lots in the SLU (multicolored) dataset.}
\label{fig:space}
\end{figure}
...
% TODO: building match figures in a horisontal grid
% TODO: figure with buildings-slu-cropped
% TODO: mention utility buildings inside compounds, source of marginal errors

% TODO: Scrape road data with same coords as the large data run
% TODO: Organize large building and road datasets
% TODO: Script that imports both building and road data
% TODO: Reconstruct geometrical hashmap to take both polygons and lines
% TODO: Implement new geometrical hashmap in new script
% TODO: Assign default path widths (min)
% TODO: Per road, go over narby features and infer max width, log collisions (max width - min width)

\begin{figure}[H]
\centering
\includegraphics[height=0.5\textheight]{img_turn_function_diff_filled}
