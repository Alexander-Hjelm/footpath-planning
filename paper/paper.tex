...
% TODO: Assign default road widths
% TODO: Implement closest edge distance (project end points on the other edge, get closest perpendicular distance) 
% TODO: Per road, go over nearby features and infer max width, log collisions (max width - min width)
