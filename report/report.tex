...
So far there have been a lot of research in modelling of road networks, but these projects have often focused on the road networks designated for cars and public transit, and seldom on pedestrian footpaths.
...
In the collision detection process, the margin of error has been taken as the positional error in the OSM dataset, which has been obtained by comparing OSM data to the Swedish University of Agricultural Sciences (SLU) building datset with known accuracy.
...
The report concludes with a study of the remaining challenges in 3D city reproduction.
...
Tidigare har det bedrivits mycket forskning inom detta område, men många projekt har valt att fokusera på de delar av vägnätet som används av bilar och kollektivtraffik, och sällan gångvägar.
...
Studien har undersökt hur vanligt det är att gångvägar kolliderar kolliderar med andra kartdetaljer såsom byggnader och andra vägar.
I denna process har felmarginalen för OSM-datamängden tagits fram genom att jämföra datamängen med en referenskarta med känd felmarginal.
OSM-datamängdens felmarginal har använts som felmarginal i kollisionsstudien.
...
Rapporten avslutas med en studie över kvarvarande utmaningar inom området återskapande av städer i 3D.
...
For the secondary research question: the geodata precision study, the positional accuracy will be estimated by comparing feature points between the OSM building dataset and the Swedish University of Agricultural Sciences (SLU) building datset with known accuracy.
...
% NOW-NOW:
% TODO: Make clear that a footpath is a type of road. Even sidewalks that run along main roads are classified as roads in OSM.
% TODO: Abstract: Reduce first paragraph (background)
% TODO: Use overlap instead of collision outside of technical contexts

% NOW:
% TODO: Introduce concepts: Collision, overlap, error
...
% TODO: The word footpath does not appear anywhere in the TOC
% TODO: Abstract: Provide more detail about what was done and how it was evaluated - rephrase "In the collision detection process"

% LATER:
% TODO: Image with road collision (Accurate data vs inaccurate data)
