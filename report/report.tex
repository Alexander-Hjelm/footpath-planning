...
% TODO: Proper citations (Fix links)
% TODO: Expand on analysis about Feature overlap

% After response from Todor:
% TODO: Write section: Utility in real world applications

% After wednesday meeting with Chris
% TODO: Algorithm showing the edge projected distance algorithm for the collision study
% TODO: Figure detailing the steps in the point-matching algorithm
% TODO: Fix citations so they adhere to the same model
% TODO: Spell check
...
3189 features collide and 7330 of edges.
...
In total there are 26473 feautures 6382579 edges, meaning that each feature on average is contructed out of 241 edges.
...
\bibitem{osm-20}
(OSM 20) OSM History Viewer - OpenStreetMap Wiki. Accessed 20-03-2020. \\
...
Stojanivski T. (2020). Viewpoint: City Information Modeling (CIM) And Digitizing Urban Design Practises. Article. Under review.
