...
In the case of rendering road networks and buildings, intersection between features can lead to rendering artifacts.
This is why ideally one would like to import road data with minimal feature overlap.
There are however coming more and more sophisticated methods for automatically correcting the most common errors.
