...
In this project, the accuracy was obtained by comparing coordinate points of OSM building footprints to those in the Swedish University of Agricultural Sciences building dataset, whose accuracy is known.
\end{abstract}
...
I detta projekt uppskattades felmarginalen genom att jämföra byggnaders koordinatpunkter i datamängen med de från en referenskarta från Svenska Lantbruksuniversitetet med känd felmarginal.
\end{abstract}
\end{otherlanguage}
