...
% REPORT
% TODO: Enter correction data in report
% TODO: Analysis, write about the building-road case
% TODO: Analysis, write about the road-road case
% TODO: Plot features before collision, building-road
% TODO: Plot features before collision, road-road
% TODO: Proposed fixing algorithm: building-road
% TODO: Proposed fixing algorithm: road-road
% TODO: Analysis, mention that footpaths were nor worse than other categories, which are included in many unity packages already
% TODO: Figure, suggested morphing, building-road case
% TODO: Figure, suggested morphing, road-road case
% TODO: Proof read report
...
\begin{figure}[H]
    ...
    \caption{The 5 identified cases over feature overlap. Top left: A building lies in paralel with a road, and the distance between the two is smaller than the minimum width of the road. Top right: A road shares a node with a building. Middle: A road is intersecting with certain building features. Bottom left: Two roads have a minimum distance that is smaller than the sum of the minimum widths of both roads. Bottom right: Two roads share a node, and a subsequent node in one road lies within the minimum width of the other road.}
    \label{fig:space}
\end{figure}
