...
//TODO: Feature mapping, how to, first of all
...
The turning function was first defined by Arkin et al. (1991), as a method for measuring the similarity of two polygons. The Turning funciton $T_c(l)$ measures the cumulative angle of the polygon's counter-clockwise tangent, as a function of the cumulative normalized length l. This project uses the turning function as it is defined by (Fan et al., 2014). For a polygon with vertices ${v_1 ... v_n}$ and line segments ${e_1 ... e_n}$ It is defined as follows.
...
The value range of $S(A, B)$ will be 0 to 1, where $S(A,B) = 1$ if the polygons are identical. 

//TODO: Completeness by building area, quotation
...
//TODO: Point proximity for positional accuracy

//TODO: Cite biljecki
When presenting CityGML geometric errors, Biljecki recommends to obtain a measure of the distribution of error, introduce a tolerance and calculate the number of features or segments that fall within this tolerance. We can used this as a complementary statistic to the average error and error variance.
