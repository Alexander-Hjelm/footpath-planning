...
It will be examined how common it is that footpaths overlap with other map features.
...
Överlappning är en typ av fel i 3D-geometrin som uppstår på grund av osäkerhet i källdatan, vilket resulterar i att 3D-modeller överlappar med varandra.
Detta kan leda till besvärliga skärningar och artifakter i den färdiga stadsmodellen.

I denna undersökning har en delmängd av OSM-datamängden över Stockholm tagits, och varje väg har givits en standardbredd enligt svenska bestämmelser.
Sedan har en geometrisk algoritm tagit alla möjliga vägpar och beräknat hur stor mängd av vägarna som skulle överlappa med andra kartdetaljer.
Studien fann att gångvägar är mindre problematiska än andra vägtyper beträffande hur många vägar som kolliderar, och således borde inte gångvägar vara svårare att inkludera i en 3D-miljö än andra vägtyper.

I studien har felmarginalen för OSM-datamängden också tagits fram.
...
Felmarginalen bestämmer toleransen mellan två punkter som kan tillåtas innan man är säker på att en väg börjar överlappa med en annan väg eller en byggnad.
...
% TODO: Even shorter abstract
% TODO: New structure: Background, problem/question, implementation/method, evaluation, results, implications
% TODO: Ensure in the abstract that it is visible that there are two research questions
