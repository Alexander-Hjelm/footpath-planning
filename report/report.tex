...
This has been done both using the linear OSM road representation and on a dataset where each road has been assigned a standard width that is in line with Swedish regulations.
The program has also calculated how many of these colliding features that can be corrected by making adjustments that are within the positional accuracy of the OSM data (See the following paragraph for the secondary contribution).
